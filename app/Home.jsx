            ...
            <div>
                    ...
                    <GridItem xs={12} sm={6} md={6} lg={3}>
                        <Card>
                            <CardHeader color="success" stats icon>
                                ...
                                <p className={this.props.classes.cardCategory}>Revenue</p>
                                <h3 className={this.props.classes.cardTitle}>$34,245</h3>
                            </CardHeader>
                            <CardFooter stats>
                                <div className={this.props.classes.stats}>
                                    <DateRange/>
                    ...
                    <GridItem xs={12} sm={6} md={6} lg={3}>
                        <Card>
                            <CardHeader color="danger" stats icon>
                                ...
                                <p className={this.props.classes.cardCategory}>Fixed Issues</p>
                                <h3 className={this.props.classes.cardTitle}>75</h3>
                            </CardHeader>
                            <CardFooter stats>
                                <div className={this.props.classes.stats}>
                                    <LocalOffer/>
                    ...
                    <GridItem xs={12} sm={6} md={6} lg={3}>
                        <Card>
                            <CardHeader color="info" stats icon>
                                ...
                                <p className={this.props.classes.cardCategory}>Followers</p>
                                <h3 className={this.props.classes.cardTitle}>+245</h3>
                            </CardHeader>
                            <CardFooter stats>
                                <div className={this.props.classes.stats}>
                                    <Update/>
                    ...
                    <GridItem xs={12}>
                        <Card>
                            <CardHeader color="success" icon>
                                ...
                                <h4 className={this.props.classes.cardIconTitle}>
                ...
                <GridContainer>
                    <GridItem xs={12} sm={12} md={4}>
                        <Card product className={this.props.classes.cardHover}>
                            <CardHeader image className={this.props.classes.cardHeaderHover}>
                                <a href="#pablo" onClick={e => e.preventDefault()}>
                            ...
                            <CardBody>
                                <div className={this.props.classes.cardHoverUnder}>
                                    <Tooltip
                                        id="tooltip-top"
                                        title="View"
                                        placement="bottom"
                                        ...
                                        <Button color="transparent" simple justIcon>
                                            <ArtTrack className={this.props.classes.underChartIcons}/>
                                        </Button>
                                    </Tooltip>
                                    <Tooltip
                                        id="tooltip-top"
                                        ...
                                        <Button color="success" simple justIcon>
                                            <Refresh className={this.props.classes.underChartIcons}/>
                                        </Button>
                                    </Tooltip>
                                    <Tooltip
                                        id="tooltip-top"
                                        ...
                                        <Button color="danger" simple justIcon>
                                            <Edit className={this.props.classes.underChartIcons}/>
                                        </Button>
                                    </Tooltip>
                                </div>
                                <h4 className={this.props.classes.cardProductTitle}>
                                    <a href="#pablo" onClick={e => e.preventDefault()}>
                                        Cozy 5 Stars Apartment
                                    </a>
                                </h4>
                                <p className={this.props.classes.cardProductDesciprion}>
                            ...
                            <CardFooter product>
                                ...
                                <div className={`${this.props.classes.stats} ${this.props.classes.productStats}`}>
